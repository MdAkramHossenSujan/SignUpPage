        ...
        <div className="flex items-center justify-center px-6 py-10 sm:px-10">
          <div className="w-full max-w-xl">
            ...
            <p className="mt-2 text-sm text-slate-600">
              You’re just a few steps away! Sign up and unlock 24/7 customer support with
              MessageMind.
            </p>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <input
                    ...
                    className="w-full rounded-2xl border border-pink-400/60 px-4 py-3 placeholder-slate-400 focus:ring-2 focus:ring-pink-400/50"
              ...
              <div>
                ...
                />
                {errors.company && (
                  <p className="text-sm text-rose-600">{errors.company.message}</p>
                )}
              </div>
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <PhoneInput
                      ...
                      inputClass="!w-full !rounded-2xl !border !border-pink-400/60 !px-4 !py-3 !placeholder-slate-400 focus:!ring-2 focus:!ring-pink-400/50"
              ...
              {errors.terms && (
                <p className="-mt-1 text-sm text-rose-600">{errors.terms.message}</p>
              )}
